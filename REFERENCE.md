...
Every Perspective response should be reducible to:
...
If a draft is missing any of the three, the response will read as vague.
...
- **All-positive Perspectives**: skipping Re-think on default reads as either disengaged or as withholding. Find one substantive thing or skip deliberately.
